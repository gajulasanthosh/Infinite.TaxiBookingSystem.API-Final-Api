...
namespace Infinite.TaxiBookingSystem.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IBookingsStatusRepository<Booking>, EmployeeRepository>();
            services.AddScoped<IGetRepository<Taxi>, TaxiRepository>();
            //services.AddScoped<IGetRepository<Customer>, CustomerRepository>();
            //services.AddScoped<IRepository<Customer>, CustomerRepository>();
            services.AddScoped<IGetRepository<Feedback>, FeedbackRepository>();
